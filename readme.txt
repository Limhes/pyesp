...
Description of code use with comments is given in all_examples.py
...
Developed and tested on Ubuntu using Python 3.7, but should run on any modern platform
